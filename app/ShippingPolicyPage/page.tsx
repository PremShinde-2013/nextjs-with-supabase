    ...
    return (
        <div className="max-w-4xl mx-auto px-6 py-16">
            ...
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
                At Skillveta, we provide **digital courses, internships, and certificates**.
            ...
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
                ...
                You will receive access links via your Skillveta account or registered email.
            </p>
            ...
            <p className="text-neutral-700 dark:text-neutral-300 mb-4">
                ...
                please contact our support team at <a href="mailto:support@skillveta.com" className="text-purple-600 underline">support@skillveta.com</a>.
            </p>

            <p className="text-neutral-600 dark:text-neutral-400 mt-8">
                Skillveta is committed to providing fast and reliable **digital delivery** for all

            ...
            >
                ...
                <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
                    <section>
                        ...
                        <p>
                            By accessing or using <strong>SkillVeta</strong>, you agree to be
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            SkillVeta, you confirm that you meet this requirement.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            ...
                            <li>SkillVeta reserves the right to suspend or terminate accounts that violate these terms.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            You agree to use SkillVeta only for lawful purposes and in
                    ...
                    <section>
                        ...
                        <p>
                            All content, trademarks, and materials on SkillVeta are the
                            property of SkillVeta or its licensors. You may not copy,
                    ...
                    <section>
                        ...
                        <p>
                            We may suspend or terminate your access to SkillVeta at any time,
                    ...
                    <section>
                        ...
                        <p>
                            SkillVeta is provided &quot;as is&quot; and we make no guarantees
                            about the availability or accuracy of our services. To the maximum
                            extent permitted by law, SkillVeta is not liable for any damages
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            of SkillVeta after updates means you accept the revised Terms.
                        </p>
                    </section>

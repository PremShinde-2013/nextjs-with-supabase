...
const fakePosts = [
    {
        ...
        text: "Just completed my Skillveta AI course! 🚀 Feeling accomplished and ready to build amazing projects.",
    },
    {
        user: "Rohan Mehta",
        ...
        text: "Finished my web dev internship at Skillveta! 💻 Check out my verified certificate. #Skillveta #Achievement",
    },
    {
        user: "Priya Nair",
        ...
        certificate: "Course",
        img: "https://dhyeneqgxucokgtxiyaj.supabase.co/storage/v1/object/public/certificates/Sample_Course_Certificate.png",
        text: "Learning never stops! Completed a premium Skillveta course with QR-verifiable certificate. 🔗",
    },
];
    ...
    return (
        <section className="max-w-7xl mx-auto py-20 px-6 md:px-12 text-center">
            ...
            <p className="text-neutral-700 dark:text-neutral-300 text-base md:text-lg max-w-3xl mx-auto mb-12">
                Real students showing off their <span className="font-semibold text-yellow-500">verified Skillveta certificates</span> on LinkedIn
            </p>
